...
import static com.example.music_clone.util.Constants.LAST_ARTIST;
import static com.example.music_clone.util.Constants.LAST_ARTIST_IMAGE;
import static com.example.music_clone.util.Constants.LAST_CATEGORY;
import static com.example.music_clone.util.Constants.MEDIA_QUEUE_POSITION;
import static com.example.music_clone.util.Constants.NOW_PLAYING;
